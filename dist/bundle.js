...
var Main = function (_Phaser$Game) {
    ...
    function Main() {
        ...
        var _this = _possibleConstructorReturn(this, (Main.__proto__ || Object.getPrototypeOf(Main)).call(this, 640, 480, Phaser.AUTO, 'container'));
...
},{"./states/bootState":2,"./states/gameState":3,"./states/preloadState":4}],2:[function(require,module,exports){
"use strict";
...
var PreloadState = function (_Phaser$State) {
    ...
    _createClass(PreloadState, [{
        key: "preload",
        value: function preload() {} // preload
